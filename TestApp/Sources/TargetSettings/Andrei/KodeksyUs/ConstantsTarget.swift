...
struct ConstantsTarget {
    ...
    static let adUnitIDBanner       = "ca-app-pub-7590866680405485/1787943945"
    static let adUnitIDInterstitial = "ca-app-pub-7590866680405485/9052190445"
    static let adUnitIDNative       = "XXXXXXXX"
    static let adUnitIDOpen         = "ca-app-pub-7590866680405485/3448509976"
    static let adUnitIDRewarded     = "XXXXXXXX"
    
    static let revenueCatPublicKey = "appl_uYqoQbDYKrthCtbBzWQXgmslOhh"
    
    static let audioBookType = "book"
    static let audioBookVersion = "US Code"
    ...
    static let newsURL = "https://news.google.com/rss/search?q=law%20us&hl=en-US&gl=US&ceid=US%3Aen"
